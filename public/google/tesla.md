...
colors:
  ...
  color-light-gray-3: "#E8EAED"
  color-white-2: "#F4F4F4"
  color-white-3: "#F5F5F5"
  color-light-gray-4: "#E5E3DF"
...
This design system was auto-extracted from https://www.tesla.com/ (20 colors · 25 type tokens · 17 spacing steps · 25 breakpoints · 10 motion tokens).

The UI favors a dark, developer-focused aesthetic with high-contrast typography and a single accent color for interactive elements.

Original extraction date: 2026-04-13T17:22:04.986Z.
...
- **color-light-gray-3 (#E8EAED):** Supporting token from the extracted palette.
...
- **color-light-gray-4 (#E5E3DF):** Supporting token from the extracted palette.
...
- **color-mid-gray (#8E8E8E):** Supporting token from the extracted palette.
- **color-blue-2 (#1A73E8):** Supporting token from the extracted palette.
...
- **color-mid-gray-2 (#A2A3A5):** Supporting token from the extracted palette.

## Typography

Primary typeface: **Universal Sans Display, Google Sans Text, Roboto, Family, Universal Sans Text**. Scale tokens map extracted font sizes to semantic roles for headings and body copy.
...
- **body-sm:** font Universal Sans Text, 11px, weight 500.
- **caption:** font Universal Sans Text, 10px, weight 500.
- **code:** font Universal Sans Display, 11px, weight 400.
...
- **lg:** `rgba(0, 0, 0, 0.3) 0px 1px 4px -1px`
- **xl:** `rgb(255, 255, 255) 0px 2px 0px -1px`
...
- **shadow-lg:** `rgba(0, 0, 0, 0.3) 0px 1px 4px -1px`
- **shadow-xl:** `rgb(255, 255, 255) 0px 2px 0px -1px`
